...
const DEFAULT_HMAC_SECRET = 'pa4qacea4VK9t9nGv7yZtwmj'
export const hmac = (data: string) => crypto.createHmac('sha256', String(process.env.HMAC_SECRET ?? DEFAULT_HMAC_SECRET)).update(data).digest('hex')
